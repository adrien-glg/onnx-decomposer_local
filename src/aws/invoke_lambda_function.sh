...
INPUT_PAYLOAD="file://events/event${layer_number}.json"
OUTPUT_PAYLOAD_FULL="events/event$((${layer_number}+1))_full.json"
OUTPUT_PAYLOAD="events/event$((${layer_number}+1)).json"
